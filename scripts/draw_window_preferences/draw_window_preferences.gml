function draw_window_preferences() {
	...
	if (selected_tab = 0) {
	    ...
	    if (draw_button2(x1 + 40 + 84, y1 + 246 + (theme = 3) * 22, 76, "Change", 0, 1)) {
	        ...
	        a = string(get_save_filename_ext_dynamic("", "Select song folder", songfolder, "Song folder"))
	    ...
	    if (draw_button2(x1 + 40 + 84, y1 + 296 + (theme = 3) * 22, 76, "Change", 0, 1)) {
	        ...
	        a = string(get_save_filename_ext_dynamic("", "Select patterns folder", patternfolder, "Pattern folder"))
	    ...
	    if (draw_button2(x1 + 40 + 84, y1 + 246 + (theme = 3) * 22, 76, "修改", 0, 1)) {
	        message("选择保存和打开的文件夹", "")
	        a = string(get_save_filename_ext_dynamic("", "选择歌曲文件夹", songfolder, "歌曲文件夹"))
	        if (a != "") songfolder = filename_dir(a)
	    }
	    ...
	    if (draw_button2(x1 + 40 + 84, y1 + 296 + (theme = 3) * 22, 76, "修改", 0, 1)) {
	        ...
	        a = string(get_save_filename_ext_dynamic("", "选择片段文件夹", patternfolder, "片段文件夹"))
	        if (a != "") patternfolder = filename_dir(a)
	    }
