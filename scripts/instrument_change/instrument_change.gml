function instrument_change(ins) {
	var fn, newfn;
	if (language != 1) fn = string(get_open_filename_ext_dynamic("Supported sounds (*.ogg;*.wav;*.mp3)|*.ogg;*.wav;*.mp3", "", sounds_directory, "Load sound file"))
	else fn = string(get_open_filename_ext_dynamic("Supported sounds (*.ogg;*.wav;*.mp3)|*.ogg;*.wav;*.mp3", "", sounds_directory, "打开声音文件"))
