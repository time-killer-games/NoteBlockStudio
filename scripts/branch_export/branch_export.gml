function branch_export() {
	// branch_export()
	var a, b, c, o
	var fn = string(get_save_filename_ext_dynamic("Minecraft Schematics (*.schematic)|*.schematic", filename_new_ext(songs[song].filename, "") + ".schematic", "", "Export Branch Schematic"))
	if (fn = "") return 0
	o = obj_controller
	window = -1
	// Start the schematic
